...
public final class GPreviewBuilder {
     ...
     * @return GPreviewBuilder
     * **/
    public GPreviewBuilder setOnLongClickListener(OnLongClickListener listener) {
        listener.getContext(mContext);
    ...
    public void start() {
        ...
        BasePhotoFragment.onLongClickListener=onLongClickListener;
