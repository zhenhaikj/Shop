...
public class MyStateFrameLayout extends FrameLayout
{
    /*初始状态，不显示任何View*/
    ...
    /*NetError视图布局id*/
    public int mNetErrorLayoutId = -1;
    /*Loading视图*/
    ...
    /*内容视图显示动画*/
    public boolean mEnableContentAnim = true;
    /*当前状态*/
    @State
    public int mCurState;
    /*重试监听*/
    public OnEmptyRetryListener mEmptyRetryListener;
    public OnNetErrorRetryListener mNetErrorRetryListener;
    public boolean mHasInit = false;

    public MyStateFrameLayout(Context context)
    {
        super(context);
        init(context, null);
    }

    public MyStateFrameLayout(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        init(context, attrs);
    }
