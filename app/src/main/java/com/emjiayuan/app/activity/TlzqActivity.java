...
public class TlzqActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        if (intent!=null){
            soupid= intent.getStringExtra("soupid");
            soupname= intent.getStringExtra("soupname");
        }
        title.setText(soupname);
    ...
    public void request(int pageindex) {
        ...
        formBody.add("categoryid", soupid);//传递键值对参数
