    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.get_yzm:
                ...
                if ("".equals(username)) {
                    MyUtils.showToast(PwdForgetActivity.this, "用户名不能为空！");
                    return;
                }
...
//                        myHandler.sendEmptyMessage(1);
            ...
            case R.id.reset:
                ...
                if ("".equals(yzm)) {
                    MyUtils.showToast(PwdForgetActivity.this, "请输入验证码！");
                    return;
                }
                if ("".equals(password)) {
                    MyUtils.showToast(PwdForgetActivity.this, "请输入密码！");
                    return;
                }
                if ("".equals(repassword)) {
                    MyUtils.showToast(PwdForgetActivity.this, "请确认密码！");
                    return;
                }
                if (!password.equals(repassword)) {
                    MyUtils.showToast(PwdForgetActivity.this, "两次输入密码不一致！");
                    return;
                }
...
//new call
                Call call2 = MyOkHttp.GetCall("User.forget", formBody2);
//请求加入调度
