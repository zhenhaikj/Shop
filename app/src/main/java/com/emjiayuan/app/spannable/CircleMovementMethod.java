package com.emjiayuan.app.spannable;
...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = AppApplication.getContext().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = AppApplication.getContext().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
