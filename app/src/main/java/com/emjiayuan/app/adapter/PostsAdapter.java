...
//        return 16;
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if ("1".equals(post.getIsadv())){
            holder.llPost.setVisibility(View.GONE);
            holder.llGg.setVisibility(View.VISIBLE);
            GlideUtil.loadImageViewLoding(mContext, post.getHeadimg(), holder.icongg, R.drawable.default_tx, R.drawable.default_tx);
            holder.usernamegg.setText(post.getNickname());
            holder.contentgg.setText(post.getContent());
            holder.timegg.setText(post.getPasttime());
            GlideUtil.loadImageViewLoding(mContext, post.getPic(), holder.ggImg, R.drawable.empty_img, R.drawable.empty_img);
        }else{
            holder.llPost.setVisibility(View.VISIBLE);
            holder.llGg.setVisibility(View.GONE);
            ...
            holder.llEdit.setVisibility((isMine && (post.getShowtype() == 0 || post.getShowtype() == 1) ? View.VISIBLE : View.GONE));
