...
public class IntegralAdapter extends BaseAdapter {
    ...
    private ArrayList<Integral> grouplists = new ArrayList<>();
    private LayoutInflater mInflater;

    public ArrayList<Integral> getGrouplists() {
        return grouplists;
    }

    public void setGrouplists(ArrayList<Integral> grouplists) {
        this.grouplists = grouplists;
    }

    public IntegralAdapter(Context mContext, ArrayList<Integral> grouplists) {
        super();
...
//        return 20;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tab_sj.setText(("2".equals(item.getStatus())?"-":"+")+item.getPoints());
